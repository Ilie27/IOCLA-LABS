...
add_dword_array_element:
    ...
    PRINTF32 `%u\n\x0`, eax
     ...
     ; TODO: Compute sum for the squared elements in dword_array.
...
add_dword_array_sqelement:
    mov ebx, [dword_array + (ecx - 1)*4]
    mov eax, ebx
    mul ebx
    add esi, edx
    add edi, eax

    loop add_dword_array_sqelement
